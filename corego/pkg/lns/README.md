...
> **Native CoreGO implementation of the Lethean Name System (LNS)**
...
| Metric | Value |
|--------|-------|
| **Total Go files** | 100+ (lns.go + pkg/* + tests) |
| **Subpackages** | 11 (pkg/* + internal/nameutil) |
| **Core Actions** | 30+ (name, dns, wallet, chain, net, mempool) |
| **Covenant States** | 8 (OPEN, BID, REVEAL, REGISTER, RENEW, REVOKE, TRANSFER, UPDATE) |
| **Record Types** | 6 (A, AAAA, TXT, NS, DS, CNAME) |
