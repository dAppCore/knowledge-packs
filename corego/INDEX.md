...
description: CoreGo package list with purposes and relationships
---
...
- [AI/ML packages](#aiml-packages) — Machine learning backends
...
| [go-cuda](file:///Users/snider/Code/core/go-cuda/) | **NVIDIA GPU (CUDA)** | CUDA | Scaffold | `dappco.re/go/cuda` |
| [go-tpu](file:///Users/snider/Code/core/go-tpu/) | **Google TPU (PJRT/XLA)** | TPU | Scaffold | `dappco.re/go/tpu` |
...
**Backend comparison:**
- MLX: Apple Silicon (Mac), optimised for gemma4
...
| [go-i18n](./pkg/i18n/README.md) | Complete | **Grammar-Aware i18n** — Semantic intent, GrammarImprint, dual-class disambiguation, CLDR pluralisation |
